...
class TestCheckSaus:
    ...
    @pytest.mark.smoke_market
    def test_sort_products_successful(self, login, logout, sort_products, sort_products_successful):
        """Проверка сортировки"""
        login()
        sort_products()
    ...
    @pytest.mark.smoke_market
    def test_get_product_successful(self, login, logout, get_product, get_product_successful):
        """Проверка покупки"""
        login()
        get_product()
