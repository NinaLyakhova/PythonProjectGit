...
def run_pytest():
    try:
        test_files_path = r"C:\Users\ninal\PycharmProjects\PythonProjectGit\test_bankxyz"
...
def generate_allure_report():
    ...
    results_path = r"C:\Users\ninal\PycharmProjects\PythonProjectGit\test_bankxyz\allure-results"
    report_path = r"C:\Users\ninal\PycharmProjects\PythonProjectGit\test_bankxyz\allure-report"
    # Запуск тестов
    run_pytest()
    # Генерация отчета
